        ...
        <Container>
                <Row className='m-3 p-1 mb-5'>
                    <Col lg={6} md={6} sm={12} className='text-center'>
                        ...
                        <Link to={'/home'}>
                        <Button style={{textAlign:'center',alignItems:'center',width:'200px',height:'50px',borderRadius:'30px'}} variant="info">Get Started  <i className="fa-solid fa-eject fa-rotate-90 fa-md"></i></Button>{' '}
                        </Link>
                    </Col>
                    ...
                    <Row className='mt-5' style={{display:'flex',justifyContent:'space-evenly'}}>
                                ...
                                <Col lg={4} md={4} sm={12} style={{marginBottom:'30px'}}className='p-4'>
                                    <Card style={{ width: '100%',borderRadius:'20px'}}>
                                        <Card.Img style={{width:'100%',height:'250px'}}variant="top" src="https://i.postimg.cc/v8h81cqx/e6c0aaaeacb3c1272f28e1494f140a45.gif" />
                                        <Card.Body>
                                ...
                                <Col lg={4} md={4} sm={12} style={{marginBottom:'30px'}} className='p-4'>
                                <Card style={{ width:'100%',borderRadius:'20px' }}>
                                        <Card.Img style={{width:'100%',height:'250px'}}variant="top" src="https://i.postimg.cc/1504ss2J/autoplaying-gifs.gif"/>
                                        <Card.Body>
                                ...
                                <Col lg={4} md={4} sm={12} style={{marginBottom:'30px'}} className='p-4'>
                                <Card style={{ width: '100%',borderRadius:'20px' }}>
                                        <Card.Img style={{width:'100%',height:'250px'}}variant="top" src="https://i.postimg.cc/VLTmCNpY/watch.gif" />
                                        <Card.Body>
