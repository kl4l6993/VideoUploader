        ...
        <Row>
            <Col lg={6} md={6} sm={12}>
                ...
                <div className='mt-5 ps-3 ms-2'>
                 <a href=" " style={{textDecoration:'none',fontSize:'20px',fontFamily:'Satisfy',color:'blue'}}> View Watch History <i class="fa-regular fa-clock fa-spin"></i></a>
            ...
            <img className='text-center'style={{width:'320px',height:'320px'}}src="https://i.postimg.cc/htxzrbvv/pngegg-5.png" alt="" />
            </Col>       
